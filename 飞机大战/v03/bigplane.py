...
class BigPlane(actor.Actor):
    ...
    def __init__(self, root, canvas, position, x, y, tags):
        super(self, BigPlane).__init__(root, canvas, position, x, y, tags,
    ...
    def exec_move(self):
        ...
        :return: none
        """
        if self.nw[1] < config.windows_bounary_row:
            # y 轴边界之内错误处理
            ...
            # y 轴边界之外错误处理
            self.base_move(self.bg_image_tags, 0, -config.windows_bounary_row)
